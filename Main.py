...
class Controller:
	...
	def __init__(self, width = 1200, height = 800):
		...
		# Monitor Puzzle
		self.tl_monitor = button.Button(1, ['images/buttons/monitor/Blue4.png','images/buttons/monitor/Green4.png','images/buttons/monitor/Red4.png','images/buttons/monitor/Yellow4.png'], (578,382), (93,61), 2, 3)
		self.tr_monitor = button.Button(2, ['images/buttons/monitor/Blue3.png','images/buttons/monitor/Green3.png','images/buttons/monitor/Red3.png','images/buttons/monitor/Yellow3.png'], (783,380), (118,67), 1, 3)
		self.bl_monitor = button.Button(3, ['images/buttons/monitor/Blue2.png','images/buttons/monitor/Green2.png','images/buttons/monitor/Red2.png','images/buttons/monitor/Yellow2.png'], (163,445), (130,108), 2, 3)
		self.br_monitor = button.Button(4, ['images/buttons/monitor/Blue1.png','images/buttons/monitor/Green1.png','images/buttons/monitor/Red1.png','images/buttons/monitor/Yellow1.png'], (431,472), (190,130), 3, 3)
		self.monitor_puzzle = puzzle.Puzzle(1, [self.tl_monitor,self.tr_monitor,self.bl_monitor,self.br_monitor])

		# Printer Puzzle
		self.printer_shape1 = button.Button(1, ['images/buttons/printer/gRec.png','images/buttons/printer/gTri.png','images/buttons/printer/gCir.png','images/buttons/printer/gPent.png'], (0,0), (0,0), 0, 5)
